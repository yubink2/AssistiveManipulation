...
class TrajectoryFollower(nn.Module):
    ...
    def _init_constraint_projection(self, T_world_to_human_base, T_right_elbow_joint_to_cp, T_eef_to_cp,
                                    human_arm_lower_limits, human_arm_upper_limits):
        self.constraint = ConstraintProjection(ur5_chain = self.differentiable_model, 
                                               ...
                                               T_right_elbow_joint_to_cp = T_right_elbow_joint_to_cp,
