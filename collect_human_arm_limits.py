...
# json_path = 'deep_mimic/mocap/data/Greeting.json'
# action = 'Greeting'
# subject = 'S11'
# fps = 24
# loop = 'wrap'
...
# motionPaths = ['deep_mimic/mocap/data/Greeting.json', 'deep_mimic/mocap/data/Eating.json', 'deep_mimic/mocap/data/Walking.json', 'deep_mimic/mocap/data/Sitting1.json']
motionPaths = ['deep_mimic/mocap/data/Greeting.json']
rightElbows = []
rightShouldersY = []
rightShouldersP = []
rightShouldersR = []
